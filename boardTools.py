        ...
        for col in range(len(board)):
            ...
            #will change the output string to show both enemies
                    ...
                    if world["enemy1loc"]["x"] == world["enemy2loc"]["x"] and world["enemy1loc"]["y"] == world["enemy2loc"]["y"]:
                        outputString += f"[{"00":2}]"
                    elif world["enemy1loc"]["x"] == world["enemy3loc"]["x"] and world["enemy1loc"]["y"] == world["enemy3loc"]["y"]:
                        outputString += f"[{"00":2}]"    
                    else:
                        outputString += f"[{"0 ":2}]"
                    ...
                    if world["enemy1loc"]["x"] == world["enemy2loc"]["x"] and world["enemy1loc"]["y"] == world["enemy2loc"]["y"]:
                        outputString += f"[{"00":2}]"
                    elif world["enemy2loc"]["x"] == world["enemy3loc"]["x"] and world["enemy2loc"]["y"] == world["enemy3loc"]["y"]:
                        outputString += f"[{"00":2}]"
                    else:
                        outputString += f"[{"0 ":2}]"
                    ...
                    if world["enemy3loc"]["x"] == world["enemy1loc"]["x"] and world["enemy3loc"]["y"] == world["enemy1loc"]["y"]:
                        outputString += f"[{"00":2}]"
                    elif world["enemy3loc"]["x"] == world["enemy2loc"]["x"] and world["enemy3loc"]["y"] == world["enemy2loc"]["y"]:
                        outputString += f"[{"00":2}]"
                    else:
                        outputString += f"[{"0 ":2}]"
